    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 text-center">
          <Badge variant="outline" className="mb-6 border-blue-200 text-blue-200 bg-blue-900/50 backdrop-blur-sm animate-delay-300">
            <Zap className="w-4 h-4 mr-2" />
            AI-Powered Resume Parsing
          </Badge>
          
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 text-white leading-tight typewriter-container">
            Welcome to Changed Technologies
          </h1>
          
          <p className="text-xl md:text-2xl text-blue-100 mb-8 max-w-4xl mx-auto leading-relaxed animate-delay-600">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-12 animate-delay-900">
            <Link to="/auth">
              <Button 
                size="lg" 
          ...
          <div className="text-blue-200 text-lg font-medium animate-delay-1200">
