...
const mockResumes = [
  {
    ...
    workHistory: [
      { company: "Google", position: "Senior Software Engineer", duration: "2020-2025" },
  ...
  },
  {
    ...
    workHistory: [
      { company: "Netflix", position: "Senior Data Scientist", duration: "2021-2025" },
  ...
  },
  {
    ...
    workHistory: [
      { company: "Amazon", position: "Senior Product Manager", duration: "2020-2025" },
...
// Add types for props
interface AllResumesProps {
  resumes?: any[];
  setResumes?: React.Dispatch<React.SetStateAction<any[]>>;
}

export default function AllResumes({ resumes: propResumes, setResumes: propSetResumes }: AllResumesProps) {
  const [internalResumes, internalSetResumes] = useState(mockResumes);
  const resumes = propResumes || internalResumes;
  const setResumes = propSetResumes || internalSetResumes;
